# entitiesdatabase
Automatically exported from code.google.com/p/entitiesdatabase
...
Engine: BerkeleyDB Language: Java

```

Commands list:

help: shows the commands list gui: opens a graphic interface exit: closes the application add_examples: fills the database with example data dump: prints the database content put_random: generate random data to fill the database cout: prints the number of entities stored $x(...):-$x(...): Follow some examples
